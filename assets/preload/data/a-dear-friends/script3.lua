...
idleoffsets = {'70', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'160', '30'}
downoffsets = {'0', '-20'}
upoffsets = {'-120', '260'}
rightoffsets = {'-80', '-30'}
...
idle_xml_name = 'sansandre_pibby_idle'
left_xml_name = 'sansandre_pibby_left'
down_xml_name = 'sansandre_pibby_down'
up_xml_name = 'sansandre_pibby_up'
right_xml_name = 'sansandre_pibby_right'
...
name_of_character_xml = 'inline_sans_pibby'
name_of_character = 'inline_sans_pibby'
name_of_notetype = 'inlinesans'
