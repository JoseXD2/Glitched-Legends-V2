...
idleoffsets = {'0', '40'} -- I recommend you have your idle offset at 0
leftoffsets = {'20', '20'}
downoffsets = {'0', '0'}
upoffsets = {'-30', '60'}
rightoffsets = {'-220', '20'}
...
idle_xml_name = 'plauser_idle'
left_xml_name = 'plauser_left'
down_xml_name = 'plauser_down'
up_xml_name = 'plauser_up'
right_xml_name = 'plauser_right'
...
name_of_character_xml = 'plauser_pibby'
name_of_character = 'plauser_pibby'
name_of_notetype = 'plauser'
