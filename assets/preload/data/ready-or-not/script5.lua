...
-- coders Name 
	...
	ArtistN3 = 'Omegafinn505'
	ArtistS3 = 40
	ArtistX3 = 305
	ArtistY3 = 420
-- Artist Name

	MusicianN1 = 'Jakeneutron'
	MusicianS1 = 40
	MusicianX1 = 630
	MusicianY1 = 320
...
-- Charters Name
	...
	DirectorN = 'Dusttoybonnie      /ElcornoXD'
    DirectorS = 45
    DirectorX = 400
    DirectorY = 525
...
--this is the first image 
	Image2art = 'credits/pineytor'
	IconX2art = 460
	IconY2art = 365
	IconS2art = 0.6
--this is the second image 
	Image3art = 'credits/omegafinn'
	IconX3art = 555
	IconY3art = 410
	IconS3art = 0.4
...
turnvalue = 20
        ...
        elseif curBeat % 6 == 0 then
turnvalue = -20

        elseif curBeat % 7 == 0 then
turnvalue = 20

        elseif curBeat % 8 == 0 then
turnvalue = -20

        elseif curBeat % 9 == 0 then
turnvalue = 20

        elseif curBeat % 10 == 0 then
turnvalue = -20

        elseif curBeat % 11 == 0 then
turnvalue = 20

        elseif curBeat % 12 == 0 then
turnvalue = -20

        elseif curBeat % 13 == 0 then
turnvalue = 20

        elseif curBeat % 14 == 0 then
turnvalue = -20
