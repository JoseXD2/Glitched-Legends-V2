...
function onCreate()
		...
		makeAnimatedLuaSprite('animatediconj', 'icons/tomjerryanimatedicon', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatediconj', 'normal', 'tomjerry_n',24, true)
		addAnimationByPrefix('animatediconj', 'losing', 'tomjerr_l', 24, true)
		addAnimationByPrefix('animatediconj', 'winning', 'tomjerr_w', 24, true)
...
function onUpdate(elapsed)
	...
	setProperty('animatediconj.y', getProperty('iconP2.y') - 35)
