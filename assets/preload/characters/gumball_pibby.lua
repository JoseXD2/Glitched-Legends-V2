...
function onCreate()
	if dadName == 'gumball_pibby' then
		makeAnimatedLuaSprite('animatedicon', 'icons/animatedicongumballpibby', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'gumball_n',24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'gumball_l', 24, true)
		addAnimationByPrefix('animatedicon', 'winning', 'gumball_win', 24, true)
