...
function onCreate()
	if dadName == 'homer_pibby' then
		makeAnimatedLuaSprite('animatedicon', 'icons/homericonanimated', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'homero_n',24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'homero_l', 24, true)
		addAnimationByPrefix('animatedicon', 'winning', 'homero_w', 24, true)
