...
function onCreate()
	if dadName == 'seiya_pibby' then
		makeAnimatedLuaSprite('animatedicon', 'icons/seiyaanimatedicons', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'seiya n ',24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'seiya w', 24, true)
