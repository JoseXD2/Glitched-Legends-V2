...
function onCreate()
	if dadName == 'senpai_pibby' then
		makeAnimatedLuaSprite('animatedicon', 'icons/iconnanimatednotfound', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'senpai_n',24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'senpai_l', 24, true)
		addAnimationByPrefix('animatedicon', 'winning', 'senpai_w', 24, true)
