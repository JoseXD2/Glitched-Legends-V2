function onCreate()
	if boyfriendName == 'bf_pibby_smal' then
...
function onUpdate(elapsed)
	...
	setProperty('animatedbficon.scale.x', getProperty('iconP1.scale.x') - 0.3)
	setProperty('animatedbficon.scale.y', getProperty('iconP1.scale.y') - 0.3)
end
